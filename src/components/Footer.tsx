            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center space-x-2">
                  <button
                    onClick={openChat}
                    className="flex items-center space-x-2 text-gold-200/70 hover:text-gold-300 transition-colors text-sm group"
                  >
                    <MessageCircle className="w-4 h-4 text-gold-400 group-hover:text-gold-300" />
